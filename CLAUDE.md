...
| Deploy / mobile build | `docs-fa/DEPLOY.md` / `docs-fa/MOBILE_SETUP.md` |
...
- High-risk: `src/lib/db/*` (local persistence) and `backend/src/routes/payments.ts` (money path).
- Generated — never hand-edit: `src/routeTree.gen.ts`, `www/`, `dist/`.
