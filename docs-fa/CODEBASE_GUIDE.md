...
- پیش‌فرض یک دستگاه فعال است؛ ادمین می‌تواند ۱ تا ۱۰ تعیین کند. سه جایگزینی در rolling 30 days مجاز و چهارمی قفل امنیتی است. lease آفلاین نشست ۱۵ روز است و هیچ قفلی دیتای محلی را حذف نمی‌کند.
