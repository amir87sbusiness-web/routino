...
- Export همیشه فعال است؛ Import فقط اشتراک پولی فعال (نه trial/free/expired). پلن پولی سه روز مانده و لحظهٔ پایان اعلان دارد؛ trial فقط روز آخر و لحظهٔ پایان.
