        ...
        <div className="flex flex-1 flex-col justify-center py-6">
          ...
          >
            {features.map(({ icon: Icon, text }) => (
              <li
                key={text}
                className="flex min-h-14 items-center gap-3 border-b border-border py-2.5 last:border-b-0"
              >
          ...
          <div className="mt-auto pt-7">
            ...
            >
              ...
              <div className="rounded-2xl border border-border bg-secondary/45 p-3.5">
                ...
                {plansState === "ready" && (
                  <div
                    className="mt-3 grid grid-cols-1 gap-2 min-[351px]:grid-cols-3"
                    aria-label={t("پلن‌های روتینو", "Routino plans")}
                  >
                    {plans.map((plan) => (
                      <div
                        key={plan.id}
                        className="flex items-center justify-between rounded-xl border border-border bg-card px-3 py-2.5 min-[351px]:block min-[351px]:px-1.5 min-[351px]:text-center"
                      >
