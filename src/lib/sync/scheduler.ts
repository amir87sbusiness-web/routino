...
export const EDIT_SYNC_DELAY_MS = 30_000;
export const FOREGROUND_SYNC_COOLDOWN_MS = 3 * 60_000;
export const FOREGROUND_MIN_BACKGROUND_MS = 60_000;
export const BOOT_SYNC_STALE_MS = 2 * 60_000;
...
export function createSyncScheduler({
  ...
  return {
    ...
    async onForeground(owner: string) {
      ...
      // three-minute freshness window below.
