/**
 * قوانین و مقررات + حریم خصوصی — به‌صورت داده‌ی خالص، نه JSX.
 *
 * چرا اینجا و نه داخل کامپوننت؟ چون این متن در دو جا نمایش داده می‌شود:
 *   ۱) داخل اپ، بخش تنظیمات (`components/LegalContent.tsx`)
 *   ۲) سایت اصلی routino.me (`landing/index.html`، ساخته‌شده با
 *      `scripts/build-landing.mjs`)
 *
 * متن حقوقی که در دو نسخه نگهداری شود، دیر یا زود دو چیز متفاوت می‌گوید — و
 * برای بررسی اینماد دقیقاً همین متن ملاک است. پس یک منبع، دو مصرف‌کننده.
 *
...
export const TERMS: readonly LegalSection[] = [
  {
    title: ["۱. پذیرش قوانین", "1. Acceptance of terms"],
    paras: [
      [
  ...
  {
    title: ["۲. معرفی سرویس", "2. The service"],
    paras: [
      [
  ...
  {
    title: ["۳. حساب کاربری", "3. Your account"],
    paras: [
      [
  ...
  {
    title: ["۴. اشتراک و پرداخت", "4. Subscription & payment"],
    paras: [
      [
  ...
  {
    title: ["۶. مسئولیت‌های کاربر", "6. User responsibilities"],
    paras: [
      [
  ...
  {
    title: ["۷. محدودیت مسئولیت", "7. Limitation of liability"],
    paras: [
      [
  ...
  {
    title: ["۸. مالکیت فکری", "8. Intellectual property"],
    paras: [
      [
  ...
  {
    title: ["۹. تغییر قوانین", "9. Changes to these terms"],
    paras: [
      [
...
export const PRIVACY: readonly LegalSection[] = [
  ...
  {
    title: ["۲. اطلاعاتی که جمع‌آوری می‌کنیم", "2. Information we collect"],
    paras: [
      [
  ...
  {
    title: ["۳. اطلاعاتی که روی دستگاه شما می‌ماند", "3. Data that stays on your device"],
    paras: [
      [
  ...
  {
    title: ["۴. نحوه‌ی استفاده از اطلاعات", "4. How we use information"],
    paras: [
      [
  ...
  {
    title: ["۵. اشتراک‌گذاری با سرویس‌های شخص ثالث", "5. Third-party services"],
    paras: [
      [
  ...
  {
    title: ["۷. حقوق شما", "7. Your rights"],
    paras: [
      [
