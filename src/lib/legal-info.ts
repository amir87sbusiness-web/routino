 ...
 * (کامپوننت `components/LegalContent.tsx`). این اطلاعات برای گرفتن «اینماد» و
 * تأیید درگاه پرداخت/پیامک لازم است.
 *
...
export const LEGAL_INFO = {
  ...
  lastUpdatedFa: "۲۷ مرداد ۱۴۰۵",
  lastUpdatedEn: "August 18, 2026",
} as const;
